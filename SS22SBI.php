      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          ...
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Geometric structures aligns the central gemstone set horizontally</p>
          </div>
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content1">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Centre Emerald stone- 2.92cts- each  accompanied by round-cut diamonds</p>
          </div>
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content2">
            ...
            Either ends of the piece coalesce into the vision, the pear cut  solitaire is enhanced in a unique setting giving a kite-shaped outer form.</p>
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="produt-img-box">
