...
<!--               <source src="./images/product/product-shots/product1.mp4" type="video/mp4">
 -->            
                            <source src="./images/product/product-shots/a_playful_meander.mp4" type="video/mp4">
</video>
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="text-break p-0">
            <h2 class="text-dark text-uppercase text-dark text-uppercase text-sm-center text-center text-lg-start text-md-start">A Playful Meander </h2>
            <p class="pro_code">
              <strong>Product code :</strong>&nbsp; SS22NAH
            </p>
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">The picturesque panorama of a meandering river, curiously weaving its way through moody terrain, remains encased in this analogue blend of tapered baguette and round-cut diamonds. Pear-shaped emeralds add a distinct definition, a homage to the riverbank carved out by her might. Stealing the centre stage, is a cushion-cut morganite, held in the delicate embrace of a basket carved out of white gold.</p>
        ...
        <div class="row">
          <div class="col-lg-6 col-12">
            <div class="zy-lifestyle-image">
              <img src="./images/lifestyle/SS22NAH-lifestyle.png">
            </div>
          </div>
          <div class="col-lg-6 col-12">
           <div class="zy-lifestyle-image">
...
<!--   <section class="product-box1 mt-5 mb-5">
        <div class="container p-0">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="produt-img-box">
                        <video autoplay loop muted playsinline>
                            <source src="./video/web-videos/calm/sketch-ZJ22NBN.mp4" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
