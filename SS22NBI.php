...
<body>
  ...
  <section class="banner-section">
    <img src="./images/banners/banner_ss22nbi.png" class="dekstop-only">
    <img src="./images/banners/banner_ss22nbi_mobile.png" class="mobile-only">
    <!--   <div class="product-title-box">
      <h2>A Flush of Evergreen</h2>
    </div> -->
  </section>
        ...
        <div class="col-lg-12 col-12">
          <div class="produt-img-box">
            <video autoplay loop muted playsinline>
              <source src="./video/web videos/Fervour/turntable-SS22NBI.mp4" type="video/mp4">
            </video>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-12">
          <div class="produt-img-box">
            <!--  <video autoplay loop muted playsinline>
              <source src="./images/product/product-shots/product2.mp4" type="video/mp4">
            </video> -->
            <video autoplay loop muted playsinline>
              <source src="./video/web-videos/Fervour/sketch-SS22NBI.mp4" type="video/mp4">
            </video>
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="text-break p-0">
            <h2
              ...
              A Flush of Evergreen</h2>
            <p class="pro_code">
              <strong>Product code :</strong>&nbsp; SS22NBI
            </p>
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">In an artistic
              re-imagination of the flow of a great river manoeuvring through tumultuous terrain, breathing a chaotic
              sense of natural refinement in the landscape - this innovative beauty of a necklace breathes.</p>
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Intricate, hexagonal
              segments linked together form the base of this piece, designed to wrap around the neck and bodice in a
              statement iconic. A glorious inlay of diamonds dazzle the framework, while emerald-cut emeralds and a
              central emerald-cut crimson tourmaline crown each section bringing an elusive touch of grace and sinuous
              movement reminiscent of the river that journeys on, singing to a rhythm of her own.</p>
        ...
        <div class="col-lg-6 col-12">
          ...
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content1">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Coloured-stone seat in
              horizontal alignment with outer hexagon with pure defined lines</p>
          </div>
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content2">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">
              Centre 6.45 carats Rubellite in Emerald cut & Emerald cut Emerald gemstones </p>
          </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          <div class="zy-lifestyle-image">
            <img src="./images/lifestyle/SS22NBI-lifestyle1.png">
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="zy-lifestyle-image">
