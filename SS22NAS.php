...
<body>
  ...
  <section class="banner-section">
    <img src="./images/banners/SS22NAS-banner.png" class="dekstop-only">
    <img src="./images/banners/SS22NAS-banner-resp.png" class="mobile-only">
  </section>
        ...
        <div class="col-lg-6 col-12">
          <div class="produt-img-box">
            <video autoplay loop muted playsinline>
              <source src="./images/product/product-shots/SS22NAS.mp4" type="video/mp4">
            </video>
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="text-break p-0">
            <h2
              ...
              Myriad Framed Perspectives Choker</h2>
            <p class="pro_code">
              <strong>Product code :</strong>&nbsp; SS22NAS
            </p>
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Streaks of round
              sapphires and emeralds delight this piece, redolent of the distant cave of ice, wherein the great Indus
              emerges. Drawing a gentle interlude is a channel of baguette-cut diamonds, resonating the river born.
              Lying encased within worlds of perspectives, fluidly varied, strands of white and champagne diamonds
              create a frame of frozen ice, beautifully preserved.</p>
        ...
        <div class="col-lg-12 col-12">
          <div class="produt-img-box">
            <video autoplay loop muted playsinline>
              ...
              <source src="./images/product/product-shots/SS22NAS_turntable.mp4" type="video/mp4">
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          <div class="text-break p-0" id="primary_content1">
            <h2
              class="text-dark text-uppercase text-dark text-uppercase text-sm-center text-center text-lg-start text-md-start">
              MYRIAD FRAMED PERSPECTIVES CHOKER
            </h2>
            <p class="textext-sm-center text-center text-lg-start text-md-start">Spikes of round-cut emeralds +  blue sapphires</p>
          </div>
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Spikes of round-cut emeralds +  blue sapphires</p>
          </div>
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content1">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">Channel-set, baguette-cut diamonds</p>
          </div>
          ...
          <div class="text-break animateIT p-0" style="display:none" id="secondry_content3">
            ...
            <p class="text-dark text-dark text-sm-center text-center text-lg-start text-md-start">
            Curved silhouette for better wearability</p>
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="produt-img-box">
      ...
      <div class="row">
        <div class="col-lg-6 col-12">
          <div class="zy-lifestyle-image">
            <img src="./images/product/SS22NAS-lifestyle1.png">
          </div>
        </div>
        <div class="col-lg-6 col-12">
          <div class="zy-lifestyle-image">
            <img src="./images/product/SS22NAS-lifestyle2.png">
          </div>
        </div>
      </div>
    </div>
